...
xssli ve güvenli input bar. `innerHTML` (açık) vs `textContent` (güvenli) farkını görmek için hazırlanmıştır.

15 çalışan payload içerir: onerror, ontoggle, onmouseover, autofocus, javascript: href vb.
